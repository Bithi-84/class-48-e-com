                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="invoiceid" name= "phone" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="area" name= "facebook" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="area" name= "twitter" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="logo" name= "logo" class="form-control"><br>

                                <img src= "{{ asset('backend/images/setting/' . $generalSettings->logo) }}" height="60"
                                    width="100">
                             ...
                             <div class="form-group">
                                ...
                                <input type="file" id="banner" name= "banner" class="form-control"><br>

                                <img src= "{{ asset('backend/images/setting/' . $generalSettings->banner) }}" height="400"
                                    width="1200">
